...
class ParserTestCase(unittest.TestCase):
    ...
    def test_organic_creation(self):
        ...
        first = self.m.vertex_position(0)
        second = self.m.vertex_position(1)
    ...
    def test_aromatic_bonds(self):
        ...
        first = self.m.vertex_position(0)
        second = self.m.vertex_position(1)
        third = self.m.vertex_position(2)
    ...
    def test_branch(self):
        ...
        first = self.m.vertex_position(0)
        root = self.m.vertex_position(1)
        branch_end = self.m.vertex_position(2)
        last = self.m.vertex_position(3)
    ...
    def test_bond(self):
        ...
        second = self.m.vertex_position(1)
        third = self.m.vertex_position(2)
        fourth = self.m.vertex_position(3)
        fifth = self.m.vertex_position(4)
        sixth = self.m.vertex_position(5)
    ...
    def test_dot(self):
        ...
        self.c = self.m.vertex_position(0)
        self.n = self.m.vertex_position(1)
